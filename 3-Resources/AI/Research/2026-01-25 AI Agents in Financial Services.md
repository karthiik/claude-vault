...
[Thariq from Anthropic Claude Code](https://x.com/trq212)

jumping on a Zoom and opening my eyes to the possibilities.

At the time the whole industry, including Fintool, was all building elaborate RAG pipelines with vector databases and embeddings. After reflecting on the future of information retrieval with agents I wrote “

[the RAG obituary](https://www.nicolasbustamante.com/p/the-rag-obituary-killed-by-agents)

” and Fintool moved fully to agentic search. We even decided to retire our precious embedding pipeline. Sad but whatever is best for the future!
...
![Image](https://pbs.twimg.com/media/G_dVo6BbwAAbxgi?format=png&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015173519529984000)
...
![Image](https://pbs.twimg.com/media/G_dVtS7aIAAxwoQ?format=png&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015173594935074816)
...
![Image](https://pbs.twimg.com/media/G_dV06cbIAAHyQw?format=png&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015173725801619456)
...
In October 2025, Anthropic formalized this with

[Agent Skills](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills)

a specification for extending Claude with modular capability packages. A skill is a folder containing a `

[SKILL.md](https://skill.md/)

` file with YAML frontmatter (name and description), plus any supporting scripts, references, or data files the agent might need.
...
![Image](https://pbs.twimg.com/media/G_dWKB5XAAAfhzB?format=jpg&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015174088579284992)
...
![Image](https://pbs.twimg.com/media/G_dWS6LawAAW5Bd?format=png&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015174241126367232)
...
Bash is more important than you think. There’s a growing conviction in the AI community that filesystems and bash are the optimal abstraction for AI agents.

[Braintrust recently ran an eval](https://www.braintrust.dev/blog/testing-if-bash-is-all-you-need)

comparing SQL agents, bash agents, and hybrid approaches for querying semi-structured data.
...
Streaming rich content with Streamdown. Text streaming is table stakes. The harder problem is streaming rich content: markdown with tables, charts, citations, math equations. We use

[Streamdown](http://ttps//github.com/nicholasgriffintn/streamdown)
...
![Image](https://pbs.twimg.com/media/G_dWczBXMAAhPT5?format=jpg&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015174411003834368)
...
![Image](https://pbs.twimg.com/media/G_dWfmxaoAABp65?format=jpg&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015174459255332864)
...
![Image](https://pbs.twimg.com/media/G_dWsd_aAAAnM9P?format=jpg&name=900x900)





](https://twitter.com/nicbstme/article/2015174818497437834/media/2015174680236392448)
...
For us, that’s financial data, domain-specific skills, real-time streaming, and the trust we’ve built with professional investors. from Building AI Agents for Financial Services

[

![](https://pbs.twimg.com/profile_images/1859460270613200898/thqbDVjW_x96.jpg)

](https://twitter.com/nicbstme)

[

Nicolas Bustamante

![](https://pbs.twimg.com/profile_images/1671215206842925056/FEPK-Df8_bigger.p
@nicbstme
